...
A [notebook](https://raw.githubusercontent.com/Wytz/migraine_biomarkers/master/Notebook.html) with the executed code is available in the Notebook.html file, which fully reproduces the results presented in the article.
